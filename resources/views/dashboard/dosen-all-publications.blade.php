...
@section('title', 'Semua Publikasi Bimbingan - Dosen')
...
<div class="min-h-screen bg-orange-50 p-6 space-y-8">
    <div class="bg-white rounded-xl p-6 shadow border border-orange-200 flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-orange-600">Semua Publikasi Bimbingan</h1>
            <p class="text-gray-700 mt-1">Daftar seluruh publikasi mahasiswa bimbingan Anda, lengkap dengan status admin dan dosen.</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border border-orange-200 rounded-lg">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="text-center py-8 text-gray-500">Belum ada publikasi bimbingan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
